...
async function runBlast(plan, { isLive = false, fromAddress } = {}) {
  ...
  for (const entry of plan) {
    ...
    const body = [
      ...
      "",
      "My name is Anthony Kelley with Imperio Federal Logistics. We are a government supply contractor supporting DLA requirements. I have " + sols.length + " active procurement need(s) in your lane.",
      "",
      "Items needed:",
      "",
      itemLines,
      ...
      "",
      "Please provide unit price, lead time, and country of origin for each item. We issue POs immediately upon award.",
      "",
      "Thank you,",
