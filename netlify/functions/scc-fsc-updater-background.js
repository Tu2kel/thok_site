...
async function classifyReply(body, subject, items, currentLanes) {
  ...
  const prompt = [
    ...
    "Rules:",
    "- decline_permanent=true whenever they give a REASON that the items are not their",
    "  line — even if they also use the words \"no bid\"/\"no quote\". Trigger phrases:",
    "  \"do not carry\", \"don't carry\", \"do not sell\", \"don't sell\", \"do not stock\",",
    "  \"not our line\", \"outside our offering/current offering\", \"out of our wheelhouse\",",
    "  \"not something we handle/provide/offer\", \"not what we do\".",
    "  The REASON governs, not the words \"no bid\". Examples that are PERMANENT (true):",
    ...
    "- decline_permanent=false ONLY for a bare pass with NO reason: \"no bid\", \"no quote\",",
    "  \"we'll pass\", \"respectfully decline\", \"can't quote this time\" and nothing more.",
    ...
    "  ASSEMBLY\"→4710 Pipe/Tube, \"PADLOCK\"→5340 Hardware, \"SLIDE,DRAWER\"→5340). If the",
    "  vendor permanently declines and none of their lanes clearly match, still return the",
    "  best-matching lane(s) for the declined items; only empty if truly nothing fits.",
