// netlify/functions/scc-rfq-inbox-background.js
// Imperio SCC — Vendor RFQ Inbox Scanner (background function, 15-min limit)
//
...
// auto-scrubs FSC codes on no-bids, sends summary email when done.
//
// Scheduled 4x/day via netlify.toml: 10AM, 1PM, 4PM, 7PM CT
// Also triggered manually via POST from Inbox Monitor UI (action: scan).
// Fast data queries (getReport, getScanLog, clearProcessed) are in scc-rfq-inbox.js.
//
