(function () {
  ...
  const { createElement: hM, useState: useMState, useRef: useMRef } = React;
  ...
  const IV = {
    canvas: "#faf7f2",
    sheen:
      "linear-gradient(160deg,#ffffff 0%,#f8f4ed 18%,#eee9df 40%,#f5f1ea 60%,#fdfaf5 80%,#f8f5ef 100%)",
    ...
    goldSolid: "#7a5000",
    goldGrad:
      "linear-gradient(to bottom,#8a5c00 22%,#b8860b 45%,#9a6800 50%,#7a5000 55%,#b8860b 78%)",
  ...
  function renderBodyHTML(raw) {
    ...
    segments.forEach((seg, i) => {
      ...
      paras.forEach((para) => {
        html +=
          "<p style=\"font-family:'Cormorant Garamond',serif;font-size:16px;line-height:1.85;color:" +
          IV.bodyColor +
          ';margin-bottom:13px;letter-spacing:.02em;text-align:justify;">' +
          para.replace(/\n/g, "<br>") +
          "</p>";
      });
      if (i < segments.length - 1) {
        html +=
          '<div style="position:relative;height:1px;background:linear-gradient(90deg,transparent,' +
          IV.goldRuleB +
          " 20%," +
          IV.goldRuleB +
          ' 80%,transparent);margin:20px 0;">' +
          '<span style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);' +
          "font-size:7px;color:" +
          IV.goldSolid +
          ';background:rgba(250,247,242,.9);padding:0 10px;line-height:1;">◆</span>' +
          "</div>";
      }
    });
    return html;
    ...
    return hM(
      "div",
      {
        ...
        style: {
          ...
          boxShadow:
            "0 0 0 4px rgba(201,168,76,.06),0 2px 24px rgba(160,110,0,.07)",
          display: "flex",
      ...
      hM(
        ...
        hM("div", {
          style: {
            ...
            height: "1px",
            background:
              "linear-gradient(90deg,transparent,rgba(201,168,76,.4) 30%,rgba(160,110,0,.7) 50%,rgba(201,168,76,.4) 70%,transparent)",
          },
        }),
        ...
        hM(
          ...
          hM(
            ...
            hM(
              ...
              "Talent Solutions · A Division of The House of Kel LLC",
            ),
          ),
        ),
        ...
        hM(
          ...
          hM(
            ...
            "(254) 226-5216 · anthony@imperiovita.co",
          ),
          hM(
            "div",
            {
              ...
              hM(
                "span",
                {
                  ...
                  style: {
                    ...
                    padding: "2px 7px",
                    border: "1px solid rgba(160,110,0,.38)",
                    color: IV.goldSolid,
                    borderRadius: "1px",
        ...
        hM(
          "div",
          {
            style: {
              ...
              border: "1px solid rgba(160,110,0,.14)",
              borderRadius: "3px",
            },
          },
          ...[
      ...
      hM("div", {
        className: "memo-body",
        style: { padding: "22px 0 0", flex: "1" },
        dangerouslySetInnerHTML: {
          __html:
            bodyHTML ||
            "<p style=\"font-family:'Cormorant Garamond',serif;font-size:16px;color:rgba(26,10,18,.28);font-style:italic;\">Begin typing in the editor panel…</p>",
        },
      }),
      ...
      hM(
        "div",
        {
          ...
          style: {
            marginTop: "auto",
            paddingTop: "20px",
            borderTop: "1px solid " + IV.goldRule,
          },
        },
        hM(
          "div",
        ...
        hM(
          ...
          "SDVOSB · CAGE 152U4 · (254) 226-5216 · anthony@imperiovita.co",
        ),
      ),
      ...
      hM(
        "div",
        {
          ...
          style: {
            marginTop: "32px",
            paddingTop: "13px",
            borderTop: "1px solid rgba(160,110,0,.22)",
            display: "flex",
            justifyContent: "space-between",
            alignItems: "center",
          },
        ...
        hM(
          ...
          "SDVOSB · CAGE 152U4 · Killeen, Texas",
        ),
      ),
    );
  }
      ...
      hM(
        ...
        hM(
          "button",
          {
            ...
            onMouseEnter: (e) => {
              ...
              e.target.style.borderColor = "rgba(201,168,76,.6)";
              e.target.style.color = "#C9A84C";
            },
            onMouseLeave: (e) => {
              e.target.style.background = "transparent";
              e.target.style.borderColor = "rgba(201,168,76,.3)";
        ...
        hM(
          "button",
          {
            ...
            onMouseEnter: (e) => {
              e.target.style.borderColor = "rgba(231,76,60,.3)";
              e.target.style.color = "rgba(231,76,60,.55)";
            },
            onMouseLeave: (e) => {
              e.target.style.borderColor = "rgba(201,168,76,.1)";
              e.target.style.color = "rgba(201,168,76,.28)";
            },
          },
          "Clear",
        ),
      ...
      hM(
        "div",
        {
          ...
          style: {
            ...
            backgroundImage:
              "radial-gradient(ellipse at 15% 0%,rgba(201,168,76,.18) 0%,transparent 55%),radial-gradient(ellipse at 85% 100%,rgba(201,168,76,.11) 0%,transparent 50%)",
